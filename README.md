# tareas_uea_7.3
Repositorio de tareas de la unidad 3 de la UEA 7

<h1>Heber Vazquez Hernández
Producción y comunicación en la cultura colaborativa
Licenciatura en Arte y Comunicación Digitales</h1>
...
<p>En mi caso, usar GitHub me ha resultado muy práctico, ya que facilita una revisión más clara y ordenada de mis tareas por parte de mi profesor. También permite que mis compañeros consulten los archivos cuando lo necesiten. Además, hace más sencillo el trabajo en equipo de forma remota e incluso simultánea, especialmente en proyectos colaborativos donde cada integrante participa desde distintas áreas para agilizar el ritmo de trabajo.</p>

<p>Por último, y como estudiante de arte digital, contar con un repositorio me da un espacio en la red donde puedo publicar mis trabajos y obras. Llevo alrededor de tres trimestres desarrollando proyectos web y otros ejercicios con distintos lenguajes de programación, por lo que GitHub se ha convertido en un recurso fundamental para organizar, mostrar y dar seguimiento a mis trabajos de la licenciatura.</p>
